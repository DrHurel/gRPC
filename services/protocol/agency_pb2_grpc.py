...
class AgencyServicesStub(object):
...
class AgencyServicesServicer(object):
    """Définition des services pour les agences
    """
...
def add_AgencyServicesServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'reservation.agency.AgencyServices', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('reservation.agency.AgencyServices', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class AgencyServices(object):
    """Définition des services pour les agences
    """
